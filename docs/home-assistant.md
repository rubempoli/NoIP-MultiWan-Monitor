...
rest:
  - resource: "http://APPHOST_IP:8085/noip.json"
    ...
    sensor:
      ...
      - name: "No-IP DDNS 01 Public IP"
        value_template: "{{ value_json.NOIP_DDNS_01_PUBLIC_IP }}"
      - name: "No-IP DDNS 02 Public IP"
        value_template: "{{ value_json.NOIP_DDNS_02_PUBLIC_IP }}"
      - name: "No-IP DDNS 03 Public IP"
        value_template: "{{ value_json.NOIP_DDNS_03_PUBLIC_IP }}"
